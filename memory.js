...
var cardChoices = [
	["pink.png", "pink_1.png"],
	["brown.png", "brown_1.png"],
	["purple.png", "purple_1.png"],
	["blue.png", "blue_1.png"],
	["green.png", "green_1.png"],
	["yellow.png", "yellow_1.png"],
	["orange.png", "orange_1.png"],
	["red.png", "red_1.png"],
	["grey.png", "grey_1.png"],
	["black.png", "black_1.png"],
	["white.png", "white_1.png"],
	["rectangle_pink.png", "rectangle_pink_1.png"],
	["rectangle_brown.png", "rectangle_brown_1.png"],
	["rectangle_purple.png", "rectangle_purple_1.png"],
	["rectangle_blue.png", "rectangle_blue_1.png"],
	["rectangle_green.png", "rectangle_green_1.png"],
	["rectangle_yellow.png", "rectangle_yellow_1.png"],
	["rectangle_orange.png", "rectangle_orange_1.png"],
	["rectangle_red.png", "rectangle_red_1.png"],
	["rectangle_grey.png", "rectangle_grey_1.png"],
	["rectangle_black.png", "rectangle_black_1.png"],
	["rectangle_white.png", "rectangle_white_1.png"],
	["arrow_pink.png", "arrow_pink_1.png"],
	["arrow_brown.png", "arrow_brown_1.png"],
	["arrow_purple.png", "arrow_purple_1.png"],
	["arrow_blue.png", "arrow_blue_1.png"],
	["arrow_green.png", "arrow_green_1.png"],
	["arrow_yellow.png", "arrow_yellow_1.png"],
	["arrow_orange.png", "arrow_orange_1.png"],
	["arrow_red.png", "arrow_red_1.png"],
	["arrow_grey.png", "arrow_grey_1.png"],
	["arrow_black.png", "arrow_black_1.png"],
	["arrow_white.png", "arrow_white_1.png"],
	["star_pink.png", "star_pink_1.png"],
	["star_brown.png", "star_brown_1.png"],
	["star_purple.png", "star_purple_1.png"],
	["star_blue.png", "star_blue_1.png"],
	["star_green.png", "star_green_1.png"],
	["star_yellow.png", "star_yellow_1.png"],
	["star_orange.png", "star_orange_1.png"],
	["star_red.png", "star_red_1.png"],
	["star_grey.png", "star_grey_1.png"],
	["star_black.png", "star_black_1.png"],
	["star_white.png", "star_white_1.png"],
	["triangle_pink.png", "triangle_pink_1.png"],
	["triangle_brown.png", "triangle_brown_1.png"],
	["triangle_purple.png", "triangle_purple_1.png"],
	["triangle_blue.png", "triangle_blue_1.png"],
	["triangle_green.png", "triangle_green_1.png"],
	["triangle_yellow.png", "triangle_yellow_1.png"],
	["triangle_orange.png", "triangle_orange_1.png"],
	["triangle_red.png", "triangle_red_1.png"],
	["triangle_grey.png", "triangle_grey_1.png"],
	["triangle_black.png", "triangle_black_1.png"],
	["triangle_white.png", "triangle_white_1.png"],
	["circle_pink.png", "circle_pink_1.png"],
	["circle_brown.png", "circle_brown_1.png"],
	["circle_purple.png", "circle_purple_1.png"],
	["circle_blue.png", "circle_blue_1.png"],
	["circle_green.png", "circle_green_1.png"],
	["circle_yellow.png", "circle_yellow_1.png"],
	["circle_orange.png", "circle_orange_1.png"],
	["circle_red.png", "circle_red_1.png"],
	["circle_grey.png", "circle_grey_1.png"],
	["circle_black.png", "circle_black_1.png"],
	["circle_white.png", "circle_white_1.png"],
	["square_pink.png", "square_pink_1.png"],
	["square_brown.png", "square_brown_1.png"],
	["square_purple.png", "square_purple_1.png"],
	["square_blue.png", "square_blue_1.png"],
	["square_green.png", "square_green_1.png"],
	["square_yellow.png", "square_yellow_1.png"],
	["square_orange.png", "square_orange_1.png"],
	["square_red.png", "square_red_1.png"],
	["square_grey.png", "square_grey_1.png"],
	["square_black.png", "square_black_1.png"],
	["square_white.png", "square_white_1.png"]
];


for(var i=0;i<cardChoices.length;i++){
	cardChoices[i][0] = "images/"+cardChoices[i][0];
	cardChoices[i][1] = "images/"+cardChoices[i][1];
...
var shuffleArray = []
for(var i=0;i<cardChoices.length;i++){
	shuffleArray.push(cardChoices[i][0])
...
var solved = "images/correct_card.png";
...
function checkMatch() {
	...
	if (firstCard === shuffleArray[0] || firstCard === shuffleArray[1]) {
		if (secondCard === shuffleArray[0] || secondCard === shuffleArray[1]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[2] || firstCard === shuffleArray[3]) {
		if (secondCard === shuffleArray[2] || secondCard === shuffleArray[3]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[4] || firstCard === shuffleArray[5]) {
		if (secondCard === shuffleArray[4] || secondCard === shuffleArray[5]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[6] || firstCard === shuffleArray[7]) {
		if (secondCard === shuffleArray[6] || secondCard === shuffleArray[7]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[8] || firstCard === shuffleArray[9]) {
		if (secondCard === shuffleArray[8] || secondCard === shuffleArray[9]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[10] || firstCard === shuffleArray[11]) {
		if (secondCard === shuffleArray[10] || secondCard === shuffleArray[11]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[12] || firstCard === shuffleArray[13]) {
		if (secondCard === shuffleArray[12] || secondCard === shuffleArray[13]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[14] || firstCard === shuffleArray[15]) {
		if (secondCard === shuffleArray[14] || secondCard === shuffleArray[15]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[16] || firstCard === shuffleArray[17]) {
		if (secondCard === shuffleArray[16] || secondCard === shuffleArray[17]) {
			theyMatch();
		} else {
			noMatch();
		}
	}
	if (firstCard === shuffleArray[18] || firstCard === shuffleArray[19]) {
		if (secondCard === shuffleArray[18] || secondCard === shuffleArray[19]) {
			theyMatch();
		} else {
			noMatch();
		}
